...
link :
  - rel: "stylesheet"
    href: "css/sample5-figurefloat.css"
---
...
![論理回路（Logic Circuit）](img/img2-logic.svg){width=210px .float-right}
...
![半加算器（Half Adder）](img/img3-adder.svg){width=210px .float-right}
